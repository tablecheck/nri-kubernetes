...
func TestGroupStatsSummary_CorrectValue(t *testing.T) {
	expectedRawData := definition.MetricGroups{
		"pod": {
			"newrelic-infra-monitoring-pjp0v": definition.RawMetrics{
			...
			"kube-dns-910330662-pflkj": definition.RawMetrics{
		...
		"container": {
			"kube-state-metrics": definition.RawMetrics{
			...
			"newrelic-infra": definition.RawMetrics{
